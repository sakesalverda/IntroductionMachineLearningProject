...
# param_grid = {'criterion': ['squared_error', 'friedman_mse', 'poisson', 'absolute_error'], 'max_depth': np.arange(3, 15)}

# rfr = Regressor()
# cv_rfr = tunecv(get_train_vars_df(train_df), train_df["SalesScaled"], rfr, param_grid = param_grid)

# print(cv_rfr.best_params_)
# # output: {'criterion': 'absolute_error', 'max_depth': 5}
...
best_params_grid = {'criterion': 'absolute_error', 'max_depth': 5}
